 ...
 */
export const generateLambdaName = (stage: Stage, serviceName: string, functionName: string): string => {
 ...
 */
export const generateLogGroupName = (stage: Stage, serviceName: string, resourceName: string): string => {
